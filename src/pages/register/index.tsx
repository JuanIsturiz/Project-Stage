    ...
    <section className="container max-w-2xl mx-auto text-center px-2 mt-2">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col items-center w-9/12 mx-auto">
          ...
          <button
            disabled={isLoading}
            className="cursor-pointer text-xl text-white rounded-lg bg-sky-300 py-2 px-4 font-medium mx-auto outline-2 outline transition-all duration-200 ease-linear outline-sky-300 hover:outline-offset-2 hover:animate-pulse dark:bg-sky-500 dark:outline-sky-500"
            type="submit"
          >
